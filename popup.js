...
generateButton.addEventListener('click', async () => {
    ...
    try {
        ...
        const response = await fetch('https://elephantsfoot-consultant-online-quote-form.vercel.app/api/create-url', {
            method: 'PUT',
...
generateFullButton.addEventListener('click', async () => {
    ...
    try {
        // Send PUT request to your API endpoint with the scoro_quote_id
        const response = await fetch('https://elephantsfoot-consultant-online-quote-form.vercel.app/api/create-full-form', {
            method: 'PUT',
            mode: 'cors',  // Add this line
            credentials: 'omit',  // Add this line
            headers: {
